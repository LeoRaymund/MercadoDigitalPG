    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            ?>
							...
							<span  style="text-align: left; color: #000000;">Total (Quetzales)</span>
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-primary" href="borrarcompra.php">Vaciar carrito</a>
      </div>
    </div>
  </div>
</div>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="precio" type="hidden" id="precio" value="4000" />
        <input name="titulo" type="hidden" id="titulo" value="articulo 1" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img class="card-img-top"  src="/MercadoDigital/public/img/macbook1.jpg" alt="...">
        
                <div class="card-body">
                        <h5 class="card-title">Producto 1</h5>
                        <p class="card-text">Descripción - Precio Q4000</p>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/gopro2.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Producto 2</h5>
                        <p class="card-text">Descripción - Precio Q3500</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="img/gopro1.jpg" class="card-img-top" alt="...">
                <div class="card-body">
